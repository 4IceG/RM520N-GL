...
if "%answer%"=="y" (
  ...
  REM Create a symbolic link (symlink) to QFlash 6.4 on the desktop
  mklink "C:\Users\Public\Desktop\QFlash 6.4" "C:\Quectel\QFlash_V6.4\QFlash_V6.4.exe"

  REM Create a symbolic link (symlink) to QFlash 6.4 in the Start Menu
  mklink "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\QFlash 6.4" "C:\Quectel\QFlash_V6.4\QFlash_V6.4.exe"
)
...
if "%answer%"=="y" (
  ...
  REM Create a symbolic link (symlink) to QNavigator 1.6.10 on the desktop
  mklink "C:\Users\Public\Desktop\QNavigator 1.6.10" "C:\Quectel\Qnavigator_V1.6.10\Qnavigator.exe"

  REM Create a symbolic link (symlink) to QNavigator 1.6.10 in the Start Menu
  mklink "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\QNavigator 1.6.10" "C:\Quectel\Qnavigator_V1.6.10\Qnavigator.exe"
)
